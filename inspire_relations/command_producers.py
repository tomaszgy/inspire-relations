...
def produce_element_block(labels=[], properties={}, variable_name=''):
...
def produce_node_block(labels=[], properties={}, variable_name=''):
    return '({})'.format(produce_element_block(labels, properties,
                                               variable_name))


def produce_relation_block(relation_type, properties={}, variable_name='',
...
def create_relation(relation_type, relation_properties={},
                    start_node_labels=[], start_node_properties={},
                    end_node_labels=[], end_node_properties={}):
...
def create_record(recid, labels=[], properties={}):
...
def connect_record_to_node(relation_type, recurl, node_labels=[],
                           node_properties={}, relation_properties={}):
...
def get_outgoing_relations(node_labels, node_properties,
                           relation_type=None, relation_properties={}, var_name='r'):
...
def get_node(node_labels=[], node_properties={}, var_name='n'):
