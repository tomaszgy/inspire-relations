...
from inspire_relations.exceptions import MissingUid
from inspire_relations.utils import extract_element
...
def render_graph_dict(graph_dict, central_node_type):
...
class GraphModelBuilder:
    ...
    def build(self, record):
        ...
        render_graph_dict(graph_dict, self._central_node_type)
